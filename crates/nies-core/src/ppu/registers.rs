...
mod tests {
    ...
    // PPUDATA semantics (buffered VRAM read, palette-immediate with mirror
    // refill, 1-or-32 v auto-increment) are covered by integration tests
    // in ppu/mod.rs that exercise Ppu::cpu_read/cpu_write end-to-end.
}
