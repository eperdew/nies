...
8021  A2 08     LDX #$08
8023  AD 16 40  LDA $4016      ; port-0 loop
8026  4A        LSR A          ; controller bit -> carry
8027  26 00     ROL $00        ; carry -> $00 bit 0, shifting left
8029  CA        DEX
802A  D0 F7     BNE $8023
802C  A2 08     LDX #$08
802E  AD 17 40  LDA $4017      ; port-1 loop
8031  4A        LSR A
8032  26 01     ROL $01
8034  CA        DEX
8035  D0 F7     BNE $802E
8037  A6 02     LDX $02        ; ring index
8039  A5 00     LDA $00
803B  9D 00 03  STA $0300,X
803E  E8        INX
803F  A5 01     LDA $01
8041  9D 00 03  STA $0300,X
8044  E8        INX
8045  86 02     STX $02
8047  40        RTI
...
- **Frame pacer (commit `547341c`, no plan task):** the manual SMB1 gate
  found 2× speed on 120 Hz ProMotion displays (M3's vsync-driven pacing).
  Added `nies-ui::pacing::FramePacer` + frontend wiring per the user's
  checkpoint-4 decision. Recorded in the design spec §10 addendum.
